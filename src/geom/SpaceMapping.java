...
public class SpaceMapping {
    ...
    public double stepx10() {
        return 50.0*Math.min(this.sxD2L(), this.syD2L());
    }
    ...
    public void updateLogViewPort(double minLogX, double maxLogX, double
    ...
    public Viewport getLogViewport() {
        Viewport vp = new Viewport(this.minLogX, this.maxLogX, this.minLogY, this.maxLogY);
        return vp;
    }
}