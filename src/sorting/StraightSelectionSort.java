...
Computational complexity: O(n^2),
    + At iteration of the first loop, it will find the i th small element. To find that element,
    this algorithm will use another loop from i + 1 to n to find that small element.
